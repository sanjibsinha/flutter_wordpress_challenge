...
import '../../model/category_id_three.dart';
...
class PostsByCategoryIDThree extends StatefulWidget {
  const PostsByCategoryIDThree({Key? key}) : super(key: key);

  @override
  State<PostsByCategoryIDThree> createState() => _PostsByCategoryIDThreeState();
}

class _PostsByCategoryIDThreeState extends State<PostsByCategoryIDThree> {
  @override
  void initState() {
    super.initState();
